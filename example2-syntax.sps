...
2) Faktoreanalyse für die Items der Kaufbereitschaft durchführen (WTPM_*)
3) ANOVA durchführen (Modell s.u.)
4) Realibilitätsanalyse für die Manipulationsvariablen durchführen (Man_*)
...
*** 2) Faktoreanalyse für die Items Kaufbereitschaft durchführen.
...
* Ergebnisse:
   ...
   - An der "Total Variance Explained" bzw. dem "Screeplot" wird deutlich, dass wie erwartet lediglich ein einziger Faktor als latenter 
     ...
     einen Großteil (>75%) der Varianz des latenten Faktors erklären
   - Die Faktor Matrix unterstreicht das Ergebnis: die Items korrelieren stark mit dem latenten Faktor theoretisch (mögliche Werite liegen zwischen
...
***>>> ALT 4) Realibilitätsanalyse für die Manipulationsvariablen durchführen.
...
:   Man_Gift_2 später auch eher einen hohen Wert angegeben hat ("Bei meinem letzten Einkauf bei Belle et Beau 
   ...
   - Für die Prüfung von Man_Gift_1 muss zudem eine neue Variable "hat Produkt für sich selber gekauft" eingeführt werden,
...
* Wir führen also zunächst eine Variable ein, deren Werte jeweils gegenteilig (invers) zu denen von GiftPurchase sind.
...
* Nun können wir die Realibilitätsberechnungen durchführen.
RELIABILITY 
...
** Dasselbe Vorgehen führen wir nun noch für die Unternehmensreputation durch.
* bei der Reputation sind allerdings die inhaltlichen Beschreibungen umgekehrt zu denen bei GiftPurchase, 
   d.h. bei Man_Rep_1 wird nach einer hohen - und bei Man_Rep_2 nach einer mäßigen Reputation gefragt. Dies
...
***>>> NEU 4) Realibilitätsanalyse für die Manipulationsvariablen durchführen.
